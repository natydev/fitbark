  ...
  context 'friend_dogs' do
    ...
    context 'when response has errors' do
      ...
      it 'raise an error Fitbark::Errors::ConnectionError' do
        expect { subject.friend_dogs }.to raise_error(Fitbark::Errors::ConnectionError)
      end
    end
  end
end
